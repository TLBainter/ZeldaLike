##[b][color=red]MovementState[/color][/b] is the base class for all movement layer states that respond to [b]onMove[/b] signals.[br]
##It owns the connect/disconnect lifecycle for [b]InputComponent.onMove[/b], eliminating boilerplate from every movement state.[br]
...
##Disconnects onMove and zeroes velocity on pause.[br]
...
##Called when the input component emits onMove.[br]
