...
func _ready():
	...
	_bat_flap_timer = _make_timer(_on_bat_flap_timer)
	_bat_squeak_timer = _make_timer(_on_bat_squeak_timer)
...
func _play_heavy_damage_sound(): _play_from_library(heavy_damage_sounds)
func _play_damage_sound(): _play_from_library(damage_sounds)
func _play_heal_sound(): _play_from_library(heal_sounds)
func _play_death_sound(): _play_from_library(death_sounds)
